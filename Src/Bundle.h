...
public:
  ...
  int Compute(boost::atomic<bool> *pbAbortSignal);    // Perform bundle adjustment. Aborts if *pbAbortSignal gets set to true. Returns number of accepted update iterations, or negative on error.
...
protected:
  ...
  template<class MEstimator> bool Do_LM_Step(boost::atomic<bool> *pbAbortSignal);
  ...
  boost::atomic<bool> *mpbAbortSignal;
};
